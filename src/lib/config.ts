	...
	feedbacks: [
		{
			...
			quote: "I would absolutely recommend him to anyone looking to seriously invest in their brand identity and logo design – 10/10.",
		},
		{
			image: "",
			author: "Chelsea Drake, Co-Owner at Raspaderia",
			quote: "Will Paterson’s team were incredibly detailed, thorough, and robust. Often with design projects, you get just that, a design, but their expertise in developing brands at all different stages really sets them apart and guides you on the “bigger picture” and the critical role each design element plays.",
		},
	],
};
